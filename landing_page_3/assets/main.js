...
(function() {
	...
	// "On Visible" animations.
		...
		onvisible.add('#image07', { style: 'fade-right', speed: 1250, intensity: 8, delay: 125, staggerOrder: '', replay: false });
		...
		onvisible.add('#container03 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 3, delay: 0, replay: false });
